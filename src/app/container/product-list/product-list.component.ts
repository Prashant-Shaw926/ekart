...
@Component({
  ...
  standalone: true,
  imports: [NgFor, CommonModule, ProductComponent, FilterComponent],
...
export class ProductListComponent {
  ...
  inStockProducts = this.products.filter((p) => p.is_in_inventory == true)
    .length;
  outOfStockProducts = this.products.filter((p) => p.is_in_inventory == false)
    .length;
